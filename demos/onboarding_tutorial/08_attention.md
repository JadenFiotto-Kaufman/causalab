...
```json
{
  ...
  "steps": {
    ...
    "pattern_curve": {
      ...
      "outputs": {"figure": "pattern_iia.png", "plotted": {"file": "pattern_iia.json"}}
    },
    "result_scan": {
    ...
    "grid": {
      ...
      "outputs": {"figure": "head_iia.png", "plotted": {"file": "head_iia.json"}}
    },
    "per_head": {
      "type": "script",
      "script": {"module": "causalab.analysis.head_stats"},
      "inputs": {
        "table": {"step": "result_scan", "file": "iia.json"},
        "layer_column": "sites.contribution.layers",
    ...
    "best": {
      ...
      "outputs": {
        "values": {"file": "values.json", "keys": {"best_layer": 14, "best_head": 11}}
      }
    }
  }
}
...
```json
{
  ...
  "method": {
    ...
    "reads": {
      "p_cf": {"site": "pattern", "pos": "all", "model": "original", "input": "counterfactual"},
...
```json
{
  ...
  "method": {
    ...
    "writes": {
      "patch": {"site": "contribution", "pos": "slot", "do": {"swap": "v_cf"}}
    },
    "intervened_models": {
      "patched": {"input": "base", "writes": ["patch"]}
    },
...
# OK: demos/onboarding_tutorial/workflows/mcqa_heads.json — 6 steps
```
...
#   pattern_scan: intervention_protocol ../protocols/mcqa_head_scan.json — 4 point(s), campaign digest 276cdca824920341…
#   pattern_curve: script causalab.io.plots.workflow_figures -> pattern_iia.json, pattern_iia.png
#   result_scan: intervention_protocol ../protocols/mcqa_head_premix_scan.json — 128 point(s), campaign digest 30335c3e4b610fb0…
