...
| **Data** | `mcqa/pairs_n64_s0` to scan, `mcqa/data#train` to fit, `mcqa/data#test` to score |
...
| **Reproduced** | ✓ 2026-08-31, `pytorch_hooks` on one H100 80GB |
...
```json
{
  ...
  "steps": {
    ...
    "grid": {
      ...
      "outputs": {"figure": "component_iia.png", "plotted": {"file": "component_iia.json"}}
    },
    "best": {
      "type": "script",
      ...
      "outputs": {
        "values": {
          "file": "values.json",
          "keys": {"best_layer": 14, "best_component": "block_output"}
        }
      }
    },
    "gate_fit_lo": {
...
```json
{
  ...
  "model": {"key": "meta-llama/Llama-3.2-1B-Instruct", "revision": "main", "dtype": "bf16"},
  "data": {
    "base": {"dataset": "mcqa/data#train", "field": "input"},
    "counterfactual": {"dataset": "mcqa/data#train", "field": "counterfactual_inputs[0]"}
  },
  "method": {
    "positions": {"slot": {"index": -1}},
    "sites": {
      "target": {"component": "block_output", "layers": [14]},
      "lm_head": {"component": "lm_head"}
    },
    ...
    "train": {
      ...
      "eval": {"every": {"epochs": 1}, "split": "mcqa/data#test", "metrics": ["iia"]},
      "seed": 0
    },
    "save": [
...
```json
{
  ...
  "model": {"key": "meta-llama/Llama-3.2-1B-Instruct", "revision": "main", "dtype": "bf16"},
  "data": {
    "base": {"dataset": "mcqa/data#test", "field": "input"},
    "counterfactual": {"dataset": "mcqa/data#test", "field": "counterfactual_inputs[0]"}
  },
  "method": {
    "positions": {"slot": {"index": -1}},
    "sites": {
...
# OK: demos/onboarding_tutorial/workflows/mcqa_components.json — 9 steps
```
...
#   scan: intervention_protocol ../protocols/mcqa_component_scan.json — 48 point(s), campaign digest 32fda735a39b6f1e…
...
#   gate_fit_lo: intervention_protocol ../protocols/mcqa_gate_fit.json — 1 point(s), authored digest bf09d8eb53a4a0a0…
#   gate_apply_lo: intervention_protocol ../protocols/mcqa_gate_apply.json — 1 point(s), authored digest ef16571ea2282d79…
#   gate_fit_mid: intervention_protocol ../protocols/mcqa_gate_fit.json — 1 point(s), authored digest 96df4e84f866e700…
#   gate_apply_mid: intervention_protocol ../protocols/mcqa_gate_apply.json — 1 point(s), authored digest 51cb9fc65fb0fe39…
#   gate_fit_hi: intervention_protocol ../protocols/mcqa_gate_fit.json — 1 point(s), authored digest 4aa300fdadea5330…
#   gate_apply_hi: intervention_protocol ../protocols/mcqa_gate_apply.json — 1 point(s), authored digest a2d07f7e6a223063…
```
...
Run on 2026-08-31, one H100 80GB, reference engine (`pytorch_hooks`), bf16. All nine steps completed; the scan produced
